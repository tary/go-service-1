...
func (m *Mesh) GetPoint(pos linmath.Vector3) (linmath.Vector3, int32, error) {
	...
	if err != nil {
		return linmath.Vector3Zero(), 0, err
	}
	...
	return linmath.Vector3Zero(), 0, errors.New("no interact point")
}
...
func (m *Mesh) GetPointAndNode(pos linmath.Vector3) (linmath.Vector3, *Node, error) {
	...
	ns, err := m.getNodeIDByPos(pos.X, pos.Z)
	if err != nil {
		return linmath.Vector3Zero(), nil, err
	}
	...
	return linmath.Vector3Zero(), nil, errors.New("no interact point")
}
...
func (m *Mesh) getCorner(cn *Node, nn *Node) (linmath.Vector3, linmath.Vector3) {
	...
	return linmath.Vector3Zero(), linmath.Vector3Zero()
}
