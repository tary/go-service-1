...
type ITinyEntity interface {
	...
	onEntityCreated(entityID uint64, entityType string, space iserver.ISpace, initParam interface{}, realPtr interface{})
}
...
func (e *TinyEntity) onEntityCreated(entityID uint64, entityType string, space iserver.ISpace, initParam interface{}, realPtr interface{}) {
	e.id = entityID
	e.typ = entityType
	e.realPtr = realPtr
	e.space = space
...
// GetStatePack 获取当前状态的打包
func (e *TinyEntity) GetStatePack() []byte {
	return e.packState
}
