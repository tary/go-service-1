...
func BenchmarkRedisHSET(b *testing.B) {
	c, _ := redis.Dial("tcp", "192.168.133.33:6379")
	defer c.Close()
...
/*func TestSimplePwd(t *testing.T) {
	c, err := redis.DialURL("redis://192.168.133.33:6379/0", redis.DialPassword("123456"))
	if err != nil {
		fmt.Println(err)
	}
...
/*	pool := &redis.Pool{
		...
		Dial: func() (redis.Conn, error) {
			return redis.Dial("tcp", "192.168.133.33:6379")
		},
	}
